...
class Index {
    ...
    async iconSet(url) {
        ...
        if (Buffer.status == 200) {
            ...
            fs.writeFileSync("src/assets/images/icon.png", png2icons.createICNS(Buffer, png2icons.BILINEAR, 0));
            fs.writeFileSync("src/assets/images/icon.png", png2icons.createICO(Buffer, png2icons.HERMITE, 0, false));
